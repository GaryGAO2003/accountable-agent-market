...
// Independent challenger for the optimistic L1 window. It posts a small challenge bond when enabled.
...
env = setKv(env, 'BOND_HOLDER_WALLET', getKv(env, 'BOND_HOLDER_WALLET') || arbiterPubkey)
...
const block = [
  ...
  `  Challenger wallet ${challengerPubkey} <- posts challenge bonds when CHALLENGER_AGENT_ENABLED=1`,
  '',
